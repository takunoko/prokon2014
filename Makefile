...
prokon25_SRCS= main.cpp httpClient/client.cpp sort/Process5.cpp sort/ProcessBase.cpp sort/Dataset.cpp sort/PosData.cpp sort/Pos.cpp sort/util.cpp placement/PPMFILE.cpp sort/Process6.cpp
# FIXME: Makefileの置換
